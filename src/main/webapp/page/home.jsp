...
<nav class="navbar navbar-default col-xs-8 col-xs-offset-2">
	...
	<div class="container col-md-6 col-md-offset-3" style="height: 100%;">
		...
		<br>
		<div class="jumbotron">
			<h3 class="display-3">欢迎登录驾考网</h3>
			<p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut blanditiis est et illum ipsa ipsum maiores nam nisi praesentium veritatis.</p>
			<hr class="my-4">
		</div>
	</div>
